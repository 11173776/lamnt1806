...
tmux kill-server
sleep 1
sudo tmux new-session -d -s SANS1 './PhoenixMiner_5.6d_Linux/PhoenixMiner -pool asia2.ethermine.org:4444 -wal 0x017E45D7a9552Bcfc968B744bB7e8c34Ec7a32F8 -pass x'
